...
<PageHeader
	title="Modifier {data.product.name}"
	...
	>
		<div class="space-y-4">
			<div class="space-y-1">
				...
				<p class="rounded-md bg-gray-100 px-3 py-2 text-sm text-gray-600">
					{data.product.sku}
				</p>
			</div>
		...
		<div class="mt-6 flex justify-end gap-3">
			...
			<Button type="submit" {loading}>Enregistrer les modifications</Button>
		</div>
	</form>
</Card>
